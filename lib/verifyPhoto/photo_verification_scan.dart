...
class PhotoScreen3After extends StatefulWidget {
  const PhotoScreen3After({
    super.key,
  });

  @override
  State<PhotoScreen3After> createState() => _PhotoScreen3AfterState();
}

class _PhotoScreen3AfterState extends State<PhotoScreen3After>
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.pushNamed(context, imageScannerAfter);
                },
                child: Container(
                  width: screenSize.width * 0.8,
